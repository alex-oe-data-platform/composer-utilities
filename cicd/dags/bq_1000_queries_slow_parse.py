...
# Optimized from static 1000-task loop to dynamic task mapping.
# This eliminates top-level DAG parsing overhead and scales dynamically at execution time.
@task
...
def make_check_kwargs(job_id: str, number: str):
    # Move database/API client calls inside execution context
